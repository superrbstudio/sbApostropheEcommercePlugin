...
/**
 * Description of PluginsbEcomAddToBasketWithOptionSlotActions
 *
 * @author pureroon
 */
class PluginsbEcomAddToBasketWithOptionSlotActions extends aSlotActions 
{
  public function executeEdit(sfRequest $request)
  {
    ...
    $this->form = new sbEcomAddToBasketWithOptionSlotEditForm($this->id, array());
    
    // get the extra value fields and serialize
    $extraValues = $request->getParameter('option-value');
    $value['option_value'] = json_encode($extraValues);
