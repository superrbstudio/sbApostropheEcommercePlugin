...
/**
 * Description of PluginsbEcomAddToBasketSlotActions
 *
 * @author pureroon
 */
abstract class PluginsbEcomAddToBasketNoQuantitySlotActions extends aSlotActions
{
	public function executeEdit(sfRequest $request)
  {
    ...
    $this->form = new sbEcomAddToBasketNoQuantitySlotEditForm($this->id, array());
