...
/**
 * Description of PluginsbEcomProductSlotActions
 *
 * @author Giles Smith <tech@superrb.com>
 */
abstract class PluginsbEcomProductSlotActions extends aSlotActions
{
	public function executeEdit(sfRequest $request)
  {
    ...
    $this->form = new sbEcomProductSlotEditForm($this->id, array());
